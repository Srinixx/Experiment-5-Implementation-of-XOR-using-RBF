...
5. To find the weights for the edges to the 1-output unit. Weights associated would be:
    ...
    bias edge
```
Developed by : S Shreenivash

Registration no : 212221040153
```
## PROGRAM:
```
import numpy as np
...
<img width="924" alt="240496591-5ca1686c-92fb-4326-9619-271297479412" src="https://github.com/Srinixx/Experiment-5-Implementation-of-XOR-using-RBF/assets/132982592/8a5ed887-e8c9-49c2-b500-5bb0dceae6c0">

<img width="915" alt="240496604-62298f20-b6bb-4933-a8f7-00366fa0e8bb" src="https://github.com/Srinixx/Experiment-5-Implementation-of-XOR-using-RBF/assets/132982592/069c7b1b-b5f1-4834-9900-d9f81c34046b">
